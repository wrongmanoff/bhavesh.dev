...
export default async function AdminDashboardPage() {
  ...
  const stats = [
    { label: "Life Feed", count: feed.count ?? 0, href: "/admin/feed" },
    { label: "Cyber", count: cyber.count ?? 0, href: "/admin/cyber" },
    { label: "Projects", count: projects.count ?? 0, href: "/admin/projects" },
    { label: "Reviews", count: reviews.count ?? 0, href: "/admin/reviews" },
    { label: "Achievements", count: achievements.count ?? 0, href: "/admin/vault" },
    { label: "Gallery", count: gallery.count ?? 0, href: "/admin/gallery" },
    { label: "Links", count: links.count ?? 0, href: "/admin/links" },
  ];
